...
git clone https://github.com/berycoin-project/gitian.sigs.git
```
...
[berycoin-project/gitian.sigs](https://github.com/berycoin-project/gitian.sigs/) repository, or if that's not possible create a pull
