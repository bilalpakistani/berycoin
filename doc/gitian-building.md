...
git clone https://github.com/berycoinproject/gitian.sigs.git
```
...
```bash
sudo cp /home/debian/berycoin/contrib/gitian-descriptors/xenial /usr/share/debootstrap/scripts
```
...
Output from `gbuild` will look something like
    ...
    From https://github.com/berycoinproject/berycoin
...
For example:
```bash
URL=https://github.com/laanwj/berycoin.git
...
# if wanting to use a different version of eth-cpp-berycoin:
./bin/gbuild --commit berycoin=${COMMIT},cpp-eth-berycoin=${ETHCOMMIT} --url berycoin=${URL},cpp-eth-berycoin=${ETHURL} ../berycoin/contrib/gitian-descriptors/gitian-linux.yml
```
...
cd /some/root/path/
git clone https://github.com/berycoinproject/berycoin-detached-sigs.git
...
[berycoinproject/gitian.sigs](https://github.com/berycoinproject/gitian.sigs/) repository, or if that's not possible create a pull
request. You can also mail the files to Jordan Earls (earlz@berycoin.org) and he will commit them.