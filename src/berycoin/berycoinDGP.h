#ifndef BERYCOINDGP_H
#define BERYCOINDGP_H
...
static const uint64_t DEFAULT_MIN_GAS_PRICE_DGP = 400;
...
public:
    ...
    BerycoinDGP(BerycoinState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
