#ifndef BERYCOINTRANSACTION_H
#define BERYCOINTRANSACTION_H
...
class BerycoinTransaction : public dev::eth::Transaction{

public:

    BerycoinTransaction() : nVout(0) {}

    BerycoinTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    BerycoinTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
