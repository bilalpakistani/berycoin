...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // berycoin
        hashUTXORoot.SetNull(); // berycoin
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //berycoin
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //berycoin
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //berycoin
    {
