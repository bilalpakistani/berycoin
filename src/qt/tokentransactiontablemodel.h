#ifndef BERYCOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define BERYCOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // BERYCOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
