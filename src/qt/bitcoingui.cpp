    ...
    platformStyle(_platformStyle)
{
    ...
    berycoinVersionChecker = new BerycoinVersionChecker(this);

    if(fCheckForUpdates && berycoinVersionChecker->newVersionAvailable())
    {
        QString link = QString("<a href=%1>%2</a>").arg(BERYCOIN_RELEASES, BERYCOIN_RELEASES);
        QString message(tr("New version of Berycoin wallet is available on the Berycoin source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::createActions()
{
    ...
    QRCTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/qrctoken"), tr("&Bery Tokens"), this);
    QRCTokenAction->setStatusTip(tr("Bery Tokens (send, receive or add Tokens in list)"));
