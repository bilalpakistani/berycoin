#ifndef BERYCOINVERSIONCHECKER_H
#define BERYCOINVERSIONCHECKER_H
...
class BerycoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BerycoinVersionChecker(QObject *parent = 0);
    ~BerycoinVersionChecker();
...
#endif // BERYCOINVERSIONCHECKER_H
