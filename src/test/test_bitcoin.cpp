...
////////////////////////////////////////////////////////////// berycoin
        ...
        globalState = std::unique_ptr<BerycoinState>(new BerycoinState(dev::u256(0), BerycoinState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::berycoinTestNetwork)));
