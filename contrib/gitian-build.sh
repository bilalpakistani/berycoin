...
VERSION=
commit=false
url=https://github.com/berycoinproject/berycoin
ethurl=https://github.com/berycoinproject/cpp-eth-berycoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the berycoin, gitian-builder, gitian.sigs, and berycoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/berycoinproject/berycoin
